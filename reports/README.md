...
- وصل [دفتر المستخدم المجمع والمقتطفات اليومية](../notebooks/README.md). توجد مخرجات لمعظم الخلايا مع فجوتين معلنتين؛ لم تُنفذ إعادة تشغيل كاملة من نسخة نظيفة. راجع [حالة الاستكمال](../SUBMISSION_STATUS.md).
